...
if (isset($_SESSION["user_id"]) && $_SESSION["user_type"] == "user") {
    ...
    if ($combinedResult->num_rows > 0) {
        echo "<h2>Electricity Bill History</h2>";
        echo "<table border='1'>";
        echo "<tr><th>Data Source</th><th>Customer ID</th><th>Units Consumed</th><th>Bill(₹)</th><th>Month</th><th>Payment Status</th></tr>";
        ...
        while ($combinedRow = $combinedResult->fetch_assoc()) {
            ...
            echo "<td>" . $combinedRow["payment_status"] . "</td>";
            echo "</tr>";
        }

        echo "</table>";
    } else {
        echo "No Combined Data Found.";
    }
